 ...
 * @since 3.15
 */
class TraceContextTaskDecoratorBeanPostProcessor implements BeanPostProcessor {

	private final ObjectProvider<TraceContextRuntime> runtime;

	TraceContextTaskDecoratorBeanPostProcessor(ObjectProvider<TraceContextRuntime> runtime) {
