...
| T1 | todo | 创建 Maven 模块骨架 | `fist-kit-infra/pom.xml`、`fist-kit-dependencies/pom.xml`、`fist-kit-infra/fist-trace-context`、`fist-kit-infra/fist-trace-context-spring-boot-starter` | 新模块可被 Maven 识别 |
